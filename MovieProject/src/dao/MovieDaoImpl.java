...
public class MovieDaoImpl implements MovieDao {
	...
	public List<MovieInfoVo> selectMovie(String movieName) throws Exception {
		...
		String sql = "SELECT movie_name, screen_num, movie_time, " + " seat_amount, price, movie_no FROM MOVIE_INFO "
				+ " WHERE movie_name = ? " + " AND movie_time >= SYSDATE-2/24 " + " AND movie_time <= SYSDATE+10/24"
	...
	public int MoviePay(int movieNo, String sList) throws Exception {
		...
		try {
			...
			String id = "admin";
			pstmt = con.prepareStatement("INSERT INTO MOVIE_BOOKING (res_seat_num, user_id, movie_no) VALUES (?, ?, ?)");
